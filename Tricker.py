...
sys.stdout.write('\x1b[1;35m\x1b]2;🌹🌻🍂💛Arslan 🙂💗 \x07')

try:os.mkdir('/storage/XYZ')
except:pass
...
def menu():
    ...
    linex()
    Arslan = input(f" \033[1;97m[\033[1;92m?\033[1;97m] Select Option : ")
    if Arslan in ['1','01']:
        random_number()
    elif Arslan in ['2','02']:
        os.system("https://www.facebook.com/profile.php?id=100094044907238")
        time.sleep(3)
        menu()
